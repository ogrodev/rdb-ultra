...
| Local support-index acceleration | `RINHIDX3`/`RINHIDX4` exact support indexes, release `x86-64-v3`, thin LTO, AVX2 distance dispatch | KD leaf-8 local k6: p99 1.58/1.55/1.56ms, scores 5801.34/5808.99/5806.20; official regressed to p99 17.34ms. KD leaf-64 local: p99 1.60/1.48ms, scores 5795.65/5829.32; official improved to p99 11.55ms. SoA AVX2 full-scan local: p99 1.49ms, FP 0, FN 0, HTTP errors 0, score 5826.98 |

Current best verified local run is now p99 1.49ms, FP 0, FN 0, HTTP errors 0, score 5826.98 with the `RINHIDX4` exact SoA support index and AVX2 lane-parallel distance scan. First official preview test on the Mac mini Late 2014 (issue #2632) returned p99 12.89ms, FP 0, FN 0, HTTP errors 0, score 4889.76. KD-tree previews preserved detection but missed the latency target: issue #3098 leaf-8 p99 17.34ms / score 4760.86, issue #3116 leaf-64 p99 11.55ms / score 4937.35. The next official preview must validate whether the SoA scan improves Haswell locality enough.
