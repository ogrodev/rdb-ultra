...
| Exact support-index acceleration | `RINHIDX3` KD-tree support index, release `x86-64-v3`, thin LTO, AVX2 distance dispatch | Leaf-8 local k6: p99 1.58/1.55/1.56ms, scores 5801.34/5808.99/5806.20, but official issue #3098 regressed to p99 17.34ms / score 4760.86. Leaf-64 retune local: p99 1.60/1.48ms, scores 5795.65/5829.32; official issue #3116 improved to p99 11.55ms / score 4937.35. A follow-up `RINHIDX4` SoA AVX2 full-scan trial was reverted after official issue #3129 returned p99 14.77ms / score 4830.74. |

Current best official preview is issue #3116: p99 11.55ms, FP 0, FN 0, HTTP errors 0, score 4937.35 with the retained `RINHIDX3` KD-tree leaf-64 support index. Current best verified local run remains p99 1.48ms, FP 0, FN 0, HTTP errors 0, score 5829.32. Exact support-index optimizations preserved detection but did not reach the official 5800 target on the Mac mini runner.
